...
async function createBooking(req, res, next) {
  try {
    ...
    try {
      // ======================================================
      // 1. FIND AVAILABLE + APPROVED WORKERS
      // ======================================================
      ...
      if (availableWorkers.length === 0) {
        ...
        // ====================================================
        // 4. CREATE BOOKING REQUEST FOR EACH WORKER
        // ====================================================
        const requests =
